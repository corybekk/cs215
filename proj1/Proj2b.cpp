...
bool check_Vocab(string SENTENCE){
  ...
  if(check_and(array4,i)!="..."){
    ...
    while(check_and(array4,i)!="..."){//keeps looping as long as there is "and" at the end of subject
      ...
      if(i==MAX-1){// if the word "and" is the last word of the sentence, prints error 
      	cout<<"Error: invalid subject2"<<endl<<endl;
	return false;
      }
      ...
      if(check_for_subject(array4,noun,subject_pro,article,commonnoun,adjective,i,n) != -1){
	current_word = check_for_subject(array4,noun,subject_pro,article,commonnoun,adjective,i,n)+1;
      }
      else{
      	cout<<"Error: invalid subject3"<<endl<<endl;
      	return false;
      }
      i=current_word;
    }
  ...
  if(check_verb(array4,i)!="..."){ //checks if current index spot is a verb.
    ...
    cout<<"Error: invalid predicate_1"<<endl<<endl;// if there is no verb it prints out an error. 
    return false;
  }
  ...
  if(check_preposition(array4,i)!="..."){//checks current index spot for preposition
    if(i==MAX-1){//if there is a preposition and its the size of the array it prints error. 
      cout<<"Error: invalid predicate_2"<<endl<<endl;
      return false;
    }
    i++;               //**************KEEPS REPEATING********************
  }
  ...
  if(check_preposition(array4,i)!="..."){
    if(i==MAX-1){
      cout<<"Error: invalid predicate_4"<<endl<<endl;
      return false;
    }
    i++;
  }
  ...
  while(check_and(array4,i)!="..."){// keeps looping as long as there is a "and" after verb
      ...
      if(i==MAX-1){
	cout<<"Error: invalid predicate_5"<<endl<<endl;
	return false;
      }
      i++;
      if(check_verb(array4,i)!="..."){
	...
	if(check_preposition(array4,i)!="..."){
	  if(i==MAX-1){
	    cout<<"Error: invalid predicate_6"<<endl<<endl;
	    return false;
	  }
	  i++;
	}
	...
	if(check_preposition(array4,i)!="..."){
	  if(i==MAX-1){
	    cout<<"Error: invalid predicate_7"<<endl<<endl;
	    return false;
	  }
	  i++;
	}
	if(check_for_object(array4,noun,object,
	  ...
	  cout<<"Error: invalid predicate1"<<endl<<endl;
	  return false;
	}
	cout<<"Error: invalid predicate2"<<endl<<endl;// if everything fails in the predicate section
	return false;                                // it returns a error.
      }
      cout<<"Error: invalid predicate3"<<endl<<endl;
      return false;
  }
  cout<<"Error: invalid predicate4"<<endl<<endl;
  return false;
}
//--------------------PRINTS SENTENCE-------------------------------------------
